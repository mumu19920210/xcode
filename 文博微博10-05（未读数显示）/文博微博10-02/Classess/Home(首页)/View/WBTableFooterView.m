...
- (void)stop
{
    ...
    _refreshStatus = NO;
    self.upPullMoreStatusText = @"上拉加载更多微博";
}

- (void)setUpPullMoreStatusText:(NSString *)upPullMoreStatusText
{
    _upPullMoreStatusText = upPullMoreStatusText;
    
    self.statusLabel.text = _upPullMoreStatusText;
}

- (void)setLoadingMoreStatusText:(NSString *)loadingMoreStatusText
{
    _loadingMoreStatusText = loadingMoreStatusText;
    
    self.statusLabel.text = _loadingMoreStatusText;
    [self start];
}
