...
//    [titleBtn setImage:[UIImage imageNamed:@"navigationbar_arrow_down"] forState:UIControlStateHighlighted];
    ...
    //    [titleBtn setBackgroundImage:[UIImage imageRemakeImageWithName:@"tabbar_background"] forState:UIControlStateHighlighted];
