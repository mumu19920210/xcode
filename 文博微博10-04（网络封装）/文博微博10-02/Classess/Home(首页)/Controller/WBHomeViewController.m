...
//
//    [WBHttpTool get:@"https://api.weibo.com/2/users/show.json" params:params success:^(id responseObj){
//
//        // screen_name是用户昵称
//        NSString *screen_name = responseObj[@"screen_name"];
...
//    }
//
//    [WBHttpTool get:@"https://api.weibo.com/2/statuses/home_timeline.json" params:params success:^(id responseObj){
//        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
//
//           [self updateStatusesWithDict:responseObj];
//        });
//    } failure:^(NSError *error){
//        WBLog(@"%@", error.domain);
//    }];
